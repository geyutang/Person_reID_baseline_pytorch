...
import scipy.io
import yaml
from model import ft_net, ft_net_dense, PCB, PCB_test, resnet_arc, dense_arc
...
def main(ids, name, which_epoch,use_dense, backbond=True, arc=False):
    ...
    parser.add_argument('--test_dir',default='/home/tanggeyu/Dataset/Market-1501/pytorch', type=str, help='./test_data')
